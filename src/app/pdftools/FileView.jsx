...
export default function FileView({file, extra , pagec}){
  ...
  return (
    <div
      className={`flex flex-col h-full w-[200px] border-2 border-green-700 py-0 px-4 `}
    >
      ...
      <PDFThumbnail src={file} deg={0} ref={fileThumbnailRef} />
      {extra && <FileRotateButtons imageRef={fileThumbnailRef} file={file} />}
      <h3>{file.pageCount + ' - '+ pagec}</h3>
    </div>
  );
